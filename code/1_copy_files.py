...
for filename in os.listdir(mettu_data):
    ...
    for di in range(3):
        ...
        annotation = pd.read_csv(annotation_file + '/Kuditta_Mettu_' + filename + '/Kuditta_mettu_' + filename + '_D' + str(di+1)  + '_S1.csv', header=None, usecols=[0,1,2])
        print(annotation)
        ...
        for index, row in annotation.iterrows():
            ...
            origin = mettu_data + filename + '/' + 'd' + str(di+1)  + '/back_images/'
